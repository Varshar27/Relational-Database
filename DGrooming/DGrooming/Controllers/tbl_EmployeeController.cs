...
namespace DGrooming.Controllers
{
    public class tbl_EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,Firstname,Lastname,Email,Address")] tbl_Employee tbl_Employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,Firstname,Lastname,Email,Address")] tbl_Employee tbl_Employee)
        {
            if (ModelState.IsValid)
            {
